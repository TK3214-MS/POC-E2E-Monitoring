        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    ...
                    statusCode = (response === null || response === void 0 ? void 0 : response.status()) || 899;
                }
                catch (_c) { }
                const traceparent = this.getTraceParentHeaderValue(request);
                this.trackPageDependency(request.method(), request.url(), statusCode, request.timing(), traceparent, (_a = request.failure()) === null || _a === void 0 ? void 0 : _a.errorText);
            }
            catch (r) {
